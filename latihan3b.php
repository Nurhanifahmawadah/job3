...
for($ds=1;$ds<=$s;$ds++){
echo"<td style=\"font-family:arial;color; #B3D9FF\"align=center valign bgcolor=\"#FFFFFF\">
</td>";}
for($d=1;$d<=$endDate;$d++){
...
$fontColor="#000000";
echo"<td style=\"font-family:arial;color; #333333\"align=center valign=middle><span
